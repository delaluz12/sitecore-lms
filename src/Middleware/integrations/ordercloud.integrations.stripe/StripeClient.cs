...
namespace ordercloud.integrations.stripe
{
    public class StripeClient
    {
        ...
        /// </summary>
        public static async Task<StripeSearchResult<Customer>> SearchCustomerAsync(CustomerSearchOptions options, StripeConfig config)
        {
            StripeConfiguration.ApiKey = config.SecretKey;
            var service = new CustomerService();
            return await service.SearchAsync(options);
        }

        /// <summary>
        /// https://stripe.com/docs/api/payment_methods/retrieve
        /// </summary>
        public static async Task<PaymentMethod> GetPaymentMethod(string pamentmethodid, StripeConfig config)
        {
            StripeConfiguration.ApiKey = config.SecretKey;
            var service = new PaymentMethodService();
            return await service.GetAsync(pamentmethodid);
        }

        /// <summary>
        /// https://stripe.com/docs/payments/save-and-reuse?platform=web#web-create-intent
        /// </summary>
        public static async Task<SetupIntent> CreateSetupIntent(SetupIntentCreateOptions options, StripeConfig config)
        {
            StripeConfiguration.ApiKey = config.SecretKey;
