...
namespace ordercloud.integrations.stripe.Interfaces
{
	/// <summary>
	...
	public interface ICreditCardProcessor
	{
		...
		/// </summary>
		Task<CCTransactionResult> AuthorizePaymentIntentAsync(AuthorizeCCTransaction transaction, OCIntegrationConfig overrideConfig = null);
		/// <summary>
		...
		/// <summary>
		/// Create a new Customer on Stripe if the customer does not already exist, or return the existing customer id.
		/// </summary>
		Task<string> GetStripeCustomerID(PaymentSystemCustomer customer, OCIntegrationConfig configOverride = null);
		/// <summary>
		/// Create a new SetupIntent on Stripe and return the client secret.
		/// </summary>
		Task<string> CreateSetupIntent(string customerID, OCIntegrationConfig configOverride = null);
		/// <summary>
		/// Create a new Payment based on Stripe payement method.
		/// </summary>
		Task<Payment> GeneratePayment(string pamentmethodid, OCIntegrationConfig configOverride = null);
	}
